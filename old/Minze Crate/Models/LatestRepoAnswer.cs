...
//    using QuickType;
//
//    var welcome = LatestRepoAnswer.FromJson(jsonString);

namespace Minze_Crate
{

    public partial class LatestRepoAnswer
    {
        [JsonProperty("url")]
    ...
    public partial class LatestRepoAnswer
    {
        public static LatestRepoAnswer FromJson(string json) => JsonConvert.DeserializeObject<LatestRepoAnswer>(json, Minze_Crate.Converter.Settings);
    }
